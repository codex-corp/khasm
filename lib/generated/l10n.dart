...
class S {
  ...
  /// `Search for Service Providers or vouchers`
  ...
  /// `Double click on the voucher to add it to the cart`
  ...
  /// `Select extras to add them on the voucher`
  ...
  /// `Longpress on the voucher to add suplements`
  ...
  /// `You can discover Service Providers & fastfood arround you and choose you best meal after few minutes we prepare and delivere it for you`
  ...
  /// `You must add vouchers of the same Service Providers choose one Service Providers only!`
  ...
  /// `Reset your cart and order meals form this Service Provider`
  ...
  /// `Keep your old meals of this Service Provider`
  ...
  /// `Service Provider refreshed successfully`
  ...
  /// `Tell us about this Service Provider`
  ...
  /// `The Service Provider has been rated successfully`
  ...
  /// `The voucher has been rated successfully`
  ...
  /// `Service Providers near to your current location`
  ...
  /// `Pickup your voucher from the Service Provider`
  ...
  /// `This voucher was added to cart`
  ...
  /// `This voucher was added to favorite`
  ...
  /// `This voucher was removed from favorites`
  ...
  /// `voucher refreshed successfully`
  ...
  /// `Delivery address outside the delivery range of this Service Providers.`
  ...
  /// `This Service Provider not support delivery method.`
  ...
  /// `One or more vouchers in your cart not deliverable.`
  ...
  /// `Click on the voucher to get more details about it`
  ...
  String get subscription_ended_msg {
    return Intl.message(
      'Your subscription is ended ,please reactivate subscription',
